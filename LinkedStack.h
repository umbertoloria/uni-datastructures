 ...
 *
 * Restituisce: 1 se è stato possibile concludere l'elaborazione.
 *              0 se è stata violata la precondizione o se non è stato
 *              possibile allocare memoria.
 */
int outputStack (LinkedStack);